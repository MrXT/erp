package com.fh.controller.bbs.reply;
...
public class ReplyController extends BaseController {
	...
	public ModelAndView save() throws Exception{
		...
		pd.put("CTIME", Tools.date2Str(new Date()));	//回复时间
	...
	public ModelAndView list(Page page) throws Exception{
		...
		page.setPd(pd);
		PageData pagedata = topicService.list(page).get(0);
		List<PageData>	varList = replyService.list(page);	//列出Reply列表
//		pagedata.put("SCAN_COUNT", Integer.parseInt(pagedata.get("SCAN_COUNT").toString())+1);
//		topicService.edit(pagedata);
		mv.setViewName("bbs/reply/reply_list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("bbs/reply/reply_edit");
	...
	public ModelAndView exportExcel() throws Exception{
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var3", varOList.get(i).getString("TOPIC_ID"));	    //3
			varList.add(vpd);
		}
