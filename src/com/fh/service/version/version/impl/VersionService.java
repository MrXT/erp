package com.fh.service.version.version.impl;
...
public class VersionService implements VersionManager{
	...
	public List<PageData> listAll(PageData pd)throws Exception{
		return (List<PageData>)dao.findForList("VersionMapper.listAll", pd);
	}
    ...
    public PageData queryNewCode(PageData pd) throws Exception {
        return (PageData)dao.findForObject("VersionMapper.queryNewCode", pd);
    }
