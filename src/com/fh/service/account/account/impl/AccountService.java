package com.fh.service.account.account.impl;
...
public class AccountService implements AccountManager{
    ...
    @SuppressWarnings("unchecked")
    @Override
    public List<PageData> findAllSet(PageData pd) throws Exception {
        return (List<PageData>)dao.findForList("AccountMapper.findAllSet", pd);
    }

    @Override
    public void editSet(PageData res) throws Exception {
        dao.update("AccountMapper.editSet", res);
    }

    @Override
    public void saveSet(PageData res) throws Exception {
        dao.save("AccountMapper.saveSet", res);
    }
