			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="meeting/signs.do" method="post" name="Form" id="Form">
								...
								<c:when test="${not empty pds}">
									<c:forEach items="${pds}" var="var" varStatus="vs">
										<tr>
											...
											<td class='center'>${var.meetingName}</td>
											<td class='center'>${var.area}</td>
											<td class='center'>${var.name}</td>
											<td class='center'>${fn:substring(var.startDate,0,16)}</td>
											<td class='center'>${fn:substring(var.endDate,0,16)}</td>
<%-- 											<td class='center'>${var.applyCount}</td> --%>
<%-- 											<td class='center'>${var.signCount}</td> --%>
											<td class="center"><a class="btn btn-mini btn-success" href="javascript:window.open('<%=basePath%>meeting/detail.do?meetingId=${var.meetingId}')">查看</a></td>
										</tr>
