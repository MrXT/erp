			...
			<div class="page-content">
				<div class="row">
					...
					<form action="account/${msg }.do" name="Form" id="Form" method="post">
						...
						<input type="hidden" name="BALANCE" id="BALANCE" value="${pd.balance}"/>
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							<tr>
								...
								<td><input type="number" name="MONEY" id="MONEY"  maxlength="32" placeholder="这里输入金额" title="余额" style="width:98%;"/></td>
							</tr>
							<tr>
...
<!-- /.main-container -->
	...
	<script type="text/javascript" src="static/js/jquery.tips.js"></script>
		...
		function save(){
			...
			var type = '${pd.STATUS}';
			if($("#MONEY").val()=="" || $("#MONEY").val()<=0 || type == 1 && $("#BALANCE").val() < $("#MONEY").val()){
				$("#MONEY").tips({
					side:3,
		            msg:'请输入正确的金额',
		            bg:'#AE81FF',
