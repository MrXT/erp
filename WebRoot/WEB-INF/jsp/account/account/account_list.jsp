													...
													<c:forEach items="${varList}" var="var" varStatus="vs">
														<tr>
															<td class='center'><label class="pos-rel"><input
																	type='checkbox' name='ids' value="${var.ACCOUNT_ID}"
																	class="ace" /><span class="lbl"></span></label></td>
															<td class='center' style="width: 30px;">${vs.index+1}</td>
															<td class='center'>${var.NAME}</td>
															<th class="center">${var.DEPARTMENT_NAME}</th>
															<th class="center">${var.OFFICE_NO}</th>
															<th class="center">${var.CPHONE}</th>
																...
																<div class="btn-group">
																	<c:if test="${QX.edit == 1 }">
																		<a class="btn btn-xs btn-success" title="编辑"
																			onclick="edit('${var.ACCOUNT_ID}',2);"> 充值 </a>
																		<a class="btn btn-xs btn-success" title="编辑"
																			onclick="edit('${var.ACCOUNT_ID}',1);"> 退费 </a>
																	</c:if>
																</div>
