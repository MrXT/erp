...
<body style="background-image: url('static/login/images/banner_slide_01.jpg;');background-size:100%; background-repeat: no-repeat;">
		...
		<div id="loginbox">
			...
			<div class="controls1">
				<div class="main_input_box1">
					<font color="white"><span id="nameerr">Copyright © 成都市金网安科技有限公司 版权所有 联系QQ:22268607@qq.com</span></font>
				</div>
			</div>
		</div>
	</div>
