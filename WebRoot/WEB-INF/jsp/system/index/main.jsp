...
<base href="<%=basePath%>">
	...
	<body class="no-skin">
			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div>
							<iframe name="mainFrame" id="mainFrame" scrolling="no" frameborder="0" src="tab.do" style="margin:0 auto;width:100%;height:900px"></iframe>
						</div>
						</div><!-- /.row -->	
					</div><!-- /.page-content -->
		...
		<div id="toTop" style="position: fixed;right: 0px;bottom: 10px;color:rgba(255, 180, 75, 0.77); font-size: 40px;cursor: pointer;"><span title="回到顶部" class="glyphicon glyphicon-chevron-up"></span></div>
